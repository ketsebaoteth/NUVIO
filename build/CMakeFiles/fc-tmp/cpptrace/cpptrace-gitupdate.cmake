...
execute_process(
  COMMAND "C:/Program Files/Git/cmd/git.exe" --git-dir=.git show-ref "3db8da80111171c219ab5839905771386bee06b3"
  WORKING_DIRECTORY "C:/Users/Predator/Documents/contribute/Nuvio/build/_deps/cpptrace-src"
...
if(show_ref_output MATCHES "^[a-z0-9]+[ \\t]+refs/remotes/")
  ...
  set(checkout_name "3db8da80111171c219ab5839905771386bee06b3")
...
elseif(show_ref_output MATCHES "^[a-z0-9]+[ \\t]+refs/tags/")
  ...
  get_hash_for_ref("3db8da80111171c219ab5839905771386bee06b3" tag_sha error_msg)
  if(tag_sha STREQUAL head_sha)
    message(VERBOSE "Already at requested tag: 3db8da80111171c219ab5839905771386bee06b3")
    return()
  endif()
...
elseif(show_ref_output MATCHES "^[a-z0-9]+[ \\t]+refs/heads/")
  ...
  set(checkout_name "origin/3db8da80111171c219ab5839905771386bee06b3")
  ...
  elseif(tag_sha STREQUAL "")
    ...
    if(NOT can_fetch)
      message(FATAL_ERROR
        "Requested git ref \"3db8da80111171c219ab5839905771386bee06b3\" is not present locally, and not "
...
if(git_update_strategy STREQUAL "CHECKOUT")
  ...
  if(error_code)
    ...
    if(NOT git_update_strategy STREQUAL "REBASE_CHECKOUT")
      ...
      message(FATAL_ERROR "\nFailed to rebase in: 'C:/Users/Predator/Documents/contribute/Nuvio/build/_deps/cpptrace-src'."
...
if(need_stash)
  ...
  if(error_code)
    ...
    if(error_code)
      ...
      message(FATAL_ERROR "\nFailed to unstash changes in: 'C:/Users/Predator/Documents/contribute/Nuvio/build/_deps/cpptrace-src'."
                          "\nYou will have to resolve the conflicts manually")
    endif()
  endif()
endif()
